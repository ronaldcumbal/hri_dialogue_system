...
template_dir = os.path.join(REPO_PATH, "ros2_workspace", "src", "woz_reception", "woz_reception", "templates")
...
class WizardInterfaceNode(Node):
    ...
    def __init__(self):
        ...
        self.utterances_file = os.path.join(REPO_PATH, "ros2_workspace", "src", "woz_reception", "config", "utterances.json")
